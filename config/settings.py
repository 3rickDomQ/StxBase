...
LOGGING = logs.get_Config(
    ...
    directories.PROD_LOG_PATH
)

DATABASES = database.get_Config(APP_CLAVE, deploy.Enviroment.PRODUCTION)
...
# AWS settings
AWS_ACCESS_KEY_ID = aws.get_AccessKeyId(APP_CLAVE, deploy.Enviroment.PRODUCTION)
AWS_SECRET_ACCESS_KEY = aws.get_SecretAccessKey(APP_CLAVE, deploy.Enviroment.PRODUCTION)
...
AWS_STORAGE_BUCKET_NAME = aws.get_FilesBucketName(APP_CLAVE, deploy.Enviroment.PRODUCTION)
