...
from .models import PageAllowed
...
class UserAdmin(SimpleHistoryAdmin):
    fieldsets = (
        ...
        (_('Información de Acceso'), {'fields': (
            'first_login',
            'is_verified',
            'session_key',
            'success_login_counter',
            'fail_login_counter',
            'reset_password',
        )}),
...
class PageAllowedInline(admin.TabularInline):
    model = PageAllowed
    extra = 1
...
class PositionAdmin(admin.ModelAdmin):
    ...
    inlines = (PermissionInline, PageAllowedInline)
...
class ThirdPartyServiceAdmin(SimpleHistoryAdmin):
    list_display = (
        'name',
        'host',
        'port',
...
class GlobalVariableAdmin(SimpleHistoryAdmin):
    list_display = (
        'key',
        'description',
        'value',
